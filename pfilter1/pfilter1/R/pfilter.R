...
pfilter(m1,params=current_params,Np=10,pred.mean = TRUE) -> ss
...
loglik_pf <- replicate(n=5,logLik(pfilter(m1,params=current_params,Np=10,pred.mean = TRUE) ))
logmeanexp(loglik_pf)
logmeanexp(c(-7310, -6600,-7360,-7360,-7556))
end_time <- Sys.time()
